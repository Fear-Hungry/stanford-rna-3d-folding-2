...
def build_parser() -> argparse.ArgumentParser:
    ...
    eidx.add_argument("--embedding-dim", type=int, default=256)
    ...
    folds.add_argument("--backend", choices=["mmseqs2", "cdhit_est", "mock"], default="mmseqs2")
    ...
    ret.add_argument("--embedding-dim", type=int, default=256)
    ...
    lab.add_argument("--thermo-backend", choices=["rnafold", "linearfold", "viennarna", "mock"], default="rnafold")
    lab.add_argument("--rnafold-bin", default="RNAfold")
    lab.add_argument("--linearfold-bin", default="linearfold")
    lab.add_argument("--msa-backend", choices=["mmseqs2", "mock"], default="mmseqs2")
    ...
    mini.add_argument("--backend", choices=["openmm", "pyrosetta", "mock"], default="openmm")
