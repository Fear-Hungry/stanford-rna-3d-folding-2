...
def build_parser() -> argparse.ArgumentParser:
    ...
    tr.add_argument("--templates", required=True)
    ...
    sr.add_argument("--templates", required=True)
    ...
    tbm.add_argument("--allow-missing-targets", action="store_true")
    tbm.add_argument("--min-template-coverage", type=float, default=1.0)
    ...
    router.add_argument("--short-max-len", type=int, default=350)
    router.add_argument("--medium-max-len", type=int, default=600)
    router.add_argument("--ultra-long-seq-threshold", type=int, default=None, help="LEGADO: alias de --medium-max-len")
    router.add_argument("--rnapro", default=None)
    router.add_argument("--chai1", default=None)
    router.add_argument("--boltz1", default=None)
    router.add_argument("--se3", default=None, help="LEGADO: alias para --se3-flash e --se3-mamba")
    router.add_argument("--se3-flash", default=None)
    router.add_argument("--se3-mamba", default=None)
    ...
    mini.add_argument("--max-iterations", type=int, default=0, help="0 desativa minimizacao; faixa valida: 0..100")
